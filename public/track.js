/**
 * Outframer Analytics — Client-side tracking
...
(function() {
  ...
  function getAnonId() {
    ...
    if (!id) {
      id = 'a_' + Math.random().toString(36).substring(2, 15) + Date.now().toString(36);
      try {
  ...
  function setupWaitlistModal() {
    const openModalButtons = document.querySelectorAll('#open-waitlist-modal-header, #open-waitlist-modal-bottom');
